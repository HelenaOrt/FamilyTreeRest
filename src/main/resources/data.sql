insert into person(name, last_name, age, country) values('Helena', 'Ortiz', 22, 'Spain');
insert into person(name, last_name, age, country) values('Juan Antonio', 'Ortiz', 60, 'Spain');
insert into person(name, last_name, age, country) values('Nacho', 'Casarrubios', 59, 'Spain');
insert into person(name, last_name, age, country, father_id) values('Diana', 'Casarrubios', 22, 'Spain', 3);
insert into person(name, last_name, age, country) values('Jose', 'Gonzalez', 60, 'Spain');
insert into person(name, last_name, age, country, father_id) values('Rocio', 'Gonzalez', 23, 'Spain', 5);
insert into person(name, last_name, age, country) values('Eugenio', 'Díaz', 55, 'Spain');
insert into person(name, last_name, age, country, father_id) values('Patricia', 'Díaz', 30, 'Spain',7);
insert into person(name, last_name, age, country, father_id) values('Jesús', 'Díaz', 30, 'Spain',7);


update person set father_id = 2 where id = 1;
